...
public class Main {
	...
	public static void main(String[] args) {
			//Main window
			MainWindow mainWindow =new MainWindow(1050,630);
			...
			PropertiesBar myTableColor=new PropertiesBar(mainWindow.getxSize()/10, mainWindow.getySize(), new EventPropertiesBar());
			WorkArea workArea=new WorkArea(800, 500);
			StatusBar statusBar=new StatusBar(mainWindow.getxSize(),  mainWindow.getySize()/32);
