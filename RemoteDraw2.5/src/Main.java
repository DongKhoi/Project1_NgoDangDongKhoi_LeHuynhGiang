...
public class Main {
	...
	public static void main(String[] args) {
			//Main window
			MainWindow mainWindow =new MainWindow(1200,630);
			...
			PropertiesBar myTableColor=new PropertiesBar(mainWindow.getxSize()/5, mainWindow.getySize(), new EventPropertiesBar());
